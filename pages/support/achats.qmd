...
Tout d'abord si vous disposez d'un ordinateur recent avec des ports USB de type USB-C (a partir des données du <a href="#table1">tableau 1</a>, il faut au moins des interfaces en USB 3.1 ou 3.2 Gen 2 pour ne pas brider la clé) et que le [**vitesse de transfert est le point le plus important pour vous**]{style="color:#ca0030;"}, la clé [Kingston DataTraveler Max](https://www.kingston.com/fr/usb-flash-drives/datatraveler-max?capacity=256gb&connector=usb-c){.external target="_blank"} est ce qui ce fait de mieux. Elle est légérement plus chère qu'une clé USB "classique" mais elle est vraiment très rapide et fonctionne aussi bien sur un pc que sur un smarphone. A note quand même que le connecteur USB-C est légérement plus fragile qu'un connecteur USB de type A et que cette clé n'est pas étanche ou antichoc. Si vous voulez en savoir plus vous trouverez un test de performance [ici](https://ssd-tester.fr/kingston_datatraveler_max_256gb.html){.external target="_blank"}.
