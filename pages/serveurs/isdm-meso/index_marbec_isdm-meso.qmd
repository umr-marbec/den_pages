...
Les parametres `partition`,  `account` et `qos` ne doivent pas etre changes pour beneficier de l'utilisation
des ressources allouees a MARBEC
...
![Connexion à la plateforme Open On Demand d'ISDM-MESO](../../../ressources/isdm-meso/meso-1.png){#fig-meso-1}

Il faut ensuite cliquer sur `Interactive Apps` et choisir l'application voulue. Ensuite, il suffit de renseigner les bonnes informations concernant les QOS, comme indiqué sur la @fig-meso-2

![Connexion à la plateforme Open On Demand d'ISDM-MESO](../../../ressources/isdm-meso/meso-1.png){#fig-meso-2}